...
const DashboardHead = ({ newProj, setNewProj, searchValue}) => {
    // if(searchValue == "Search Projectundefined"){
    //     searchValue = "Search Project"
    // }
    return (
                    ...
                    {!newProj &&
                        <>
                            <InputBase
                                ...
                                style={{
                                    minWidth: "400px", borderStyle: "solid", borderWidth: "1px", paddingLeft: "10px", borderColor: "lightgrey", borderRadius: "15px"
                                }}
                                sx={{ ml: 1, flex: 1 }}
                                type="text"
